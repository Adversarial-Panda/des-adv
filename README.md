...
- We propose **OURS**, a novel surrogate selection method that dynamically selects the most competent combination of surrogate models for each test sample using a Dynamic Ensemble Selection (DES) framework.
...
- We conduct extensive experiments on three benchmark datasets, demonstrating that **OURS** consistently improves both performance and stability across all evaluated ensemble attack methods.
